...
class US006_BackupRestore : E2ETestBase() {
    ...
    fun AC2_createIncrementalBackup() {
        ...
        step("切换到增量模式并创建增量备份")
        composeTestRule.onNodeWithText("创建备份").performScrollTo().performClick()
        composeTestRule.onNodeWithText("增量").performScrollTo().performClick()
    ...
    fun AC3_restoreBackup() {
        ...
        step("执行恢复操作")
        composeTestRule.onNodeWithText("restore-target").performScrollTo().performClick()
    ...
    fun AC4_deleteBackup() {
        ...
        step("删除备份")
        composeTestRule.onNodeWithText("to-delete-backup").performScrollTo().performClick()
    ...
    fun AC5_viewBackupMetadata() {
        ...
        step("查看备份详情")
        composeTestRule.onNodeWithText("meta-backup").performScrollTo().performClick()
        composeTestRule.waitForIdle()
        // 应显示备份信息和关联的VM名
